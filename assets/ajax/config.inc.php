<?php
  ...
  $debugGroups = ['u0info', 'u0infoti', 'u0ivsb'];                                                      # Nutzergruppen, die Zugriff auf die Debug-Ausgaben haben
  $GLOBALS['DEBUG'] = $debug;
  $dsbIDs = ['tk23279', 'hdahlman', 'nmeye_01'];                                                        # Nutzerkennungen, die Zugriff auf den DSB-View haben (Datenschutzbeauftragte)
  ...
  $base_dir = $base_dir ? $base_dir : "/www/data/ZIV.CERT";
  ...
  $includes_dir = "$base_dir/htdocs/sys/secdoc";      # Hier liegen die HTML Include-Bausteine
  ...
  #$imap_pass   = user_get_password($imap_user);
